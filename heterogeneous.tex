...
% is measured by... - JJ
EAs depend on a set of parameters which can be
adapted to increase its performance. Among them,
the population size
 is a key factor in the performance, because it has an effect on the quality of the
...
characteristics and computational requirements have been used. In this
