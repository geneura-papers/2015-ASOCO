...
The main question we try to address int this work is: Is it worth fitting the sub-populations sizes of a dEA to the computational power of every node? To best answer this question we build a set of experiments with several characteristics in mind:
\begin{itemize}
\item The separate study of two parameter settings: offline and online.
\item Three problems as different as we can find.
\end{itemize}
