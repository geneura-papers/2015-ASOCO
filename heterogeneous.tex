...
\cite{ONEMAX} and the Rosenbrock's Function \cite{CEC2005_Benchmark}. 
...
These problems have been previously used in other parameter adaptation algorithms, such as \cite{ParallelGATongchim02} (MMDP and OneMax) and \cite{DifferentialWeber09,AdaptationSizesSchlierkamp96} (Rosenbrock's). 
...
The Shifted Rosenbrock's Function is defined as:
...
% Antonio - Fergu, �Necesitas poner el �ptimo aqu�?
...
Individual size for Rosenbrock's & 10, 30 and 40 \\ \hline
...
\caption{Time to obtain the optimum in the Rosenbrock's function problem (milliseconds).}
...
\caption{Evaluations to obtain the optimum in the Rosenbrock's function problem.}
