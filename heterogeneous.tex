...
and HeSi) is taken into account. For the shake of clarity in results, 
...
A base configuration with the same sub-population sizes has been used on a heterogeneous cluster. The results have been used to calculate offline the computational power of each node, comparing the average number of generations to find the optimal solution. These proportions are used to set the new sub-population sizes. Also, a possible way to fit online the sub-population sizes has been performed comparing the current generation number between each node and its previous neighbour in the topology. 
...
\newblock Topologies, migration rates, and multi-population parallel genetic
  algorithms.
\newblock In Wolfgang Banzhaf, Jason~M. Daida, A.~E. Eiben, Max~H. Garzon,
...
Juan~Francisco Garamendi and Jos{\'{e}}~Luis Bosque.
...
\bibitem{SOASOCO}
Pablo Garc{\'{\i}}a{-}S{\'{a}}nchez, J.~Gonz{\'{a}}lez, Pedro~A. Castillo,
  Maribel~Garc{\'{\i}}a Arenas, and Juan Juli{\'{a}}n~Merelo Guerv{\'{o}}s.
...
Juan Juli{\'{a}}n~Merelo Guerv{\'{o}}s, Pedro A.~Castillo Valdivieso, Juan
  Lu{\'{\i}}s~Jim{\'{e}}nez Laredo, Antonio~Mora Garc{\'{\i}}a, and Alberto
  Prieto.
...
Juan Lu{\'{\i}}s~Jim{\'{e}}nez Laredo, Carlos~M. Fernandes, Juan
  Juli{\'{a}}n~Merelo Guerv{\'{o}}s, and Christian Gagn{\'{e}}.
...
J.~A. Mart{\'{\i}}nez, Francisco Almeida, Ester~M. Garz{\'{o}}n, Alejandro
...
P.~N. Suganthan, N.~Hansen, J.~J. Liang, K.~Deb, Y.~P. Chen, A.~Auger, and
  S.~Tiwari.
...
Mario~Garc{\'{\i}}a Valdez, Leonardo Trujillo, Juan Juli{\'{a}}n~Merelo
