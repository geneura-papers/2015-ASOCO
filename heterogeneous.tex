...
To study the scalability, two different numbers of nodes have been used in each problem and configuration: 4 nodes (from HeN1/HoN1 to HeN4/HoN4, referred as  {\em 4X} configuration for the rest of the paper) and 8 nodes (from HeN1/HoN1 to HeN8/HoN8, referred {\em 8X} configuration). The same amount of nodes been previously used in other works on dEAs on heterogeneous environments \cite{HETEROGENEOUSHARD,HYDROCM,Salto13Distributed}.
