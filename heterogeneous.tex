...
Figure \ref{fig:adaptivesize} shows the average sub-population sizes for each problem of the AdSi/HeHa runs. As can be seen, the behaviour of these sizes is also affected by the problem used. In OneMax...
...
This paper presents a study on the fitting of the sub-population sizes of a distributed EA to the computational power of the different nodes of an heterogeneous cluster. Two parameter setting schemes (offline and online) that use information of the computational load of the algorithm have been tested.
 				% No. Tratamos de
...
the migration. The sub-population size fitting is also affected by the problem being solved.
...
number between each node and its previous neighbour. These results are a promising starting for fitting EAs to the
...
As future work, other parameters such as migration rate or
